...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../paginas/cssPaginaCadastro/style.css">
...
<body>
    ...
    <div class="faleConoscoConteudo">
        ...
        <div class="alinhando_conteudo">
            <form action="cssPaginaCadastro/processaCadastro.php" method="post">
                <table>
                    <tbody>
                        ...
                        <tr> <!-- INICIO LINHA TELEFONE-->
                            ...
                            <td>
                                <input type="number" name="telefone" maxlength="9" size="20" placeholder="Número"
                                    required>
                            </td>
                        ...
                        <tr> <!-- INICIO LINHA CPF-->
                            ...
                            <td>
                                <input type="number" name="cpf" maxlength="11" size="33">
                            </td>
                        </tr><!--FIM LINHA CPF-->
                    </tbody>
                    <tfoot>
